<nav>
    ...
    <a href="show_profile.php"><img  class="profilo" src="../assets/icon/navbar/Profilo.png" alt="icona grafica stilizzata di una persona con i capelli castano il cappello nero e gli occhiali"></a>
</nav>